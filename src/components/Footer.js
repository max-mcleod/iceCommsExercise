...
export default function Footer() {
    return (
        <div className='bg-black py-10'>
            <div className='grid xl:grid-cols-3 xl:grid-rows-2 md:grid-cols-2 md:grid-rows-2 grid-cols-1 xl:px-20 md:text-left text-center text-white'>
                <img className='xl:order-1 md:order-1 md:ml-10 m-auto' src="../assets/svg/logo-white.svg" alt="" />
                <div className='xl:order-4 md:order-4 xl:m-10 md:mx-10 md:m-5 mt-10'>
                ...
                <div className='xl:order-2 xl:row-span-2 md:col-span-2 md:order-3 xl:m-10 md:mx-10 mt-10 tracking-widest'>
                ...
                <div className='order-last md:m-10 md:text-right opacity-40'>Copyright 2019. All Rights Reserved</div>
            </div>
        </div >
    )
}
